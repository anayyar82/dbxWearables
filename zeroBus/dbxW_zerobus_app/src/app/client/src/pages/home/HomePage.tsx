...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   Sections: Hero, Architecture Flow, ZeroBus Explainer, Authentication,
             Record Types, Medallion Architecture
   ═══════════════════════════════════════════════════════════════════════ */
  ...
  return (
    <section className="gradient-hero text-white py-20 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-[var(--dbx-red)] blur-[100px]" />
        <div className="absolute bottom-10 right-20 w-96 h-96 rounded-full bg-[var(--dbx-orange)] blur-[120px]" />
      </div>
    ...
    <section className="py-20 px-6 bg-[var(--background)]">
      <div className="max-w-6xl mx-auto">
        <SectionHeader
          ...
          subtitle="From wrist to Lakehouse — how HealthKit data travels through the ZeroBus gateway into Unity Catalog."
        />
